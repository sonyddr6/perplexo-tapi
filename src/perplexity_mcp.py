...
def list_models():
    ...
    return jsonify({
        "models": [
            ...
            {"id": "claude-4.6-opus", "name": "🎭🆕 Claude 4.6 Opus", "description": "Modelo mais recente da Anthropic (NOVO!)"},
            {"id": "claude-4.6-opus-thinking", "name": "🎭💭 Claude 4.6 Opus Think", "description": "Claude 4.6 com raciocínio (NOVO!)"},
